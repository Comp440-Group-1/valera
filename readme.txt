...
## version table
when release is deemed stable - it becomes a "version"
Because of "version" has more properties than just a release several tables are created to contain these additional attributes.
